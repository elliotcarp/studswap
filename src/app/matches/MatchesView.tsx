...
export default function MatchesView() {
  ...
  return (
    <main className="flex flex-col p-6 pb-24 md:ml-56 md:pb-6">
      ...
      <h1 className="mb-4 font-display text-2xl font-bold">Your matches</h1>
      ...
      {matches?.length === 0 && (
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-gray-200 px-6 py-16 text-center">
          <span className="flex h-16 w-16 items-center justify-center rounded-full bg-riviera/10">
      ...
      <ul className="flex flex-col divide-y">
        {matches?.map((match) => (
          <li key={match.matchId} className="flex items-center gap-3 py-3">
